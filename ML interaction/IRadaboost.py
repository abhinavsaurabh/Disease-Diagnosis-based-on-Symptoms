...
def ADA(X,Y,sample_x,df_norm,dataset_symptoms,final_symp,scores):
  adaclf = AdaBoostClassifier(n_estimators=50, learning_rate=1)
  adaclf.fit(X,Y)
  prediction = adaclf.predict_proba([sample_x])
  ...
  print(f"\nTop {k} diseases predicted based on symptoms by Ada Boost")
  topk_dict = {}
