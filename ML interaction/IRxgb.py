...
def XGB(X,Y,sample_x,df_norm,dataset_symptoms,final_symp,scores):
  xgbmod = xgb.XGBClassifier()
  xgbmod.fit(X,Y)
  prediction = xgbmod.predict_proba([sample_x])
  ...
  print(f"\nTop {k} diseases predicted based on symptoms by XGB")
  topk_dict = {}
