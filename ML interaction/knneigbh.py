...
def knn1(X,Y,sample_x,df_norm,dataset_symptoms,final_symp,scores):
  knn_obj=knn()
  knn_obj.fit(X,Y)
  prediction = knn_obj.predict_proba([sample_x])
  ...
  print(f"\nTop {k} diseases predicted based on symptoms by KNN")
  topk_dict = {}
